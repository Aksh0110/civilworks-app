      ...
      <div className="flex flex-row items-center justify-between gap-2 bg-white border border-slate-200 p-3 rounded-xl shadow-2xs">
        <div>
          <div className="flex items-center gap-1.5">
            ...
            <h1 className="text-base font-extrabold text-slate-900">Work Update Entry</h1>
          </div>
        ...
        <button
          ...
          className="px-2.5 h-8 bg-[#EAF7EF] hover:bg-[#d5edd9] text-[#056B34] border border-[#bce6cb] text-[11px] font-bold rounded-lg transition-colors shadow-2xs flex items-center gap-1 shrink-0"
        >
